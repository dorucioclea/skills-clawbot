...
```bash
# List products
curl -s -X GET "https://gateway.maton.ai/woocommerce/wp-json/wc/v3/products" -H "Authorization: Bearer $MATON_API_KEY"
```
...
```bash
curl -s -X GET "https://ctrl.maton.ai/connections?app=woocommerce&status=ACTIVE" -H "Authorization: Bearer $MATON_API_KEY"
```

### Create Connection

```bash
curl -s -X POST "https://ctrl.maton.ai/connections" -H "Content-Type: application/json" -H "Authorization: Bearer $MATON_API_KEY" -d '{"app": "woocommerce"}'
```
...
```bash
curl -s -X GET "https://gateway.maton.ai/woocommerce/wp-json/wc/v3/products" -H "Authorization: Bearer $MATON_API_KEY" -H "Maton-Connection: 21fd90f9-5935-43cd-b6c8-bde9d915ca80"
```
